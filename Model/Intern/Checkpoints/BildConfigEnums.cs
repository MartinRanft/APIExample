...
using ByteWizardApi.Controllers.Intern;

namespace ByteWizardApi.Model.Intern.Checkpoints
{
    /// <summary>
    /// Represents an abstract class for handling configuration enumerations related to images.
    /// </summary>
    public abstract class BildConfigEnums
    {
        /// <summary>
        /// Enumeration representing different AI models available for generating images. The models are differentiated
        /// based on their specific attributes and purposes, such as aesthetic enhancement, furry model variations,
        /// hentai creation, and others used for realistic or standard image productions.
        /// </summary>
        public enum Modelle
        {
            /// <summary>
        ...
        /// <summary>
        /// Represents the different possible states of a LoRaWAN stack.
        /// </summary>
    ...
    /// <summary>
    /// Provides extension methods for retrieving descriptions and categorizing enum values.
    /// </summary>
    internal static class EnumExtensions
    {
        
        /// <summary>
        /// Retrieves the description attribute of an enum value for Linux.
        /// </summary>
        /// <param name="enumValue">The enum value whose description is to be retrieved.</param>
        /// <typeparam name="T">The type of the enum.</typeparam>
        /// <returns>The description of the enum value after processing backslashes with Path.Combine if found; otherwise, null.</returns>
        public static string? GetDescriptionLinux<T>(this T enumValue) where T : IConvertible
        {
            ...
            // Get Beschreibungs-Attribut and use `Path.Combine`
            string? description = (from int val in values
            ...
            // if `description` contains a backslash, it is combined with `Path.Combine` to create a new description
            if (!string.IsNullOrEmpty(description) && description.Contains("\\"))
            {
                string[] parts = description.Split('\\');
                description = Path.Combine(parts);
            }
            return description;
        }

        /// <summary>
        /// Retrieves the description attribute of an enum value for Windows.
        /// </summary>
        /// <param name="enumValue">The enum value whose description is to be retrieved.</param>
        /// <typeparam name="T">The type of the enum.</typeparam>
        /// <returns>The description of the enum value if found; otherwise, null.</returns>
        public static string? GetDescriptionWin<T>(this T enumValue) where T : IConvertible
        {
            if(enumValue is not Enum)
            {
...
#pragma warning restore
        ...
        /// <summary>
        /// Retrieves the AI description attribute of a specified enum value.
        /// </summary>
        /// <param name="enumValue">The enum value from which to retrieve the AI description.</param>
        /// <typeparam name="T">The type of the enum.</typeparam>
        /// <returns>The AI description associated with the enum value; or null if no description is present.</returns>
        ...
        /// <summary>
        /// Retrieves the category name from the description attribute of an enum value.
        /// </summary>
        /// <param name="enumValue">The enum value whose category is to be retrieved.</param>
        /// <typeparam name="T">The type of the enum.</typeparam>
        /// <returns>The category name extracted from the description of the enum value; if the description contains a backslash, the portion before the backslash is returned as the category, otherwise the whole description is returned.</returns>
        private static string GetCategory<T>(this T enumValue)
        {
            ...
            string category = description.Contains('\\') ? description.Split('\\')[0] : description;
            return category;
        }
    }
}